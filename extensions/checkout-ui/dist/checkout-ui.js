...
${errorInfo.componentStack}`);
  ...
  var deliveryAddress = reactExtension("purchase.checkout.delivery-address.render-before", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Extension, {}));
  function Extension() {
    ...
    const [selectedLocation, setSelectedLocation] = (0, import_react12.useState)(null);
    (0, import_react12.useEffect)(() => {
      fetch("https://pig-rochester-monitor-cleared.trycloudflare.com/locations").then((response) => response.json()).then((data2) => {
        setData(data2);
        setSelectedLocation(data2[0]);
      });
    }, []);
    const handleAddressChange = (newLocation) => {
      ...
      applyShippingAddressChange == null ? void 0 : applyShippingAddressChange({
        type: "updateShippingAddress",
        address: {
          address1: newLocation.address,
          city: newLocation.city,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
      ...
      data && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        ChoiceList2,
        {
          name: "location",
          value: JSON.stringify(selectedLocation),
          onChange: (selectedLocationString) => {
            const selectedLocation2 = JSON.parse(selectedLocationString);
            handleAddressChange(selectedLocation2);
          },
          children: data.map((location) => {
            console.log("Choice id:", location.address);
            return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Choice2, { id: JSON.stringify(location), children: location.address }, location.id);
          })
        }
      )
    ] });
